...
-- IMPORTANT: Only grant on specific application tables, not ALL TABLES
-- to avoid exposing system tables like schema_migrations
...
-- This prevents the schema_migrations table from being accessed via the API
